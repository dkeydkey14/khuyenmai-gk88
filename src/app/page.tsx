        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap md:flex-nowrap justify-between mb-6">
            ...
            <div className="w-full md:w-3/12 mb-6 md:mb-0 px-0 md:px-6">
              ...
              <ul className="list-none">
                <li className="py-1.5">
                  <a href="https://gk88.ai/" className="text-orange-100 hover:text-white flex items-center">
            ...
            <div className="w-full md:w-3/12 mb-6 md:mb-0">
              ...
              <ul className="list-none">
                <li className="py-1.5">
                  <a href="https://t.me/GK88HOTRO24H_BOT" className="text-orange-100 hover:text-white flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className="py-1.5">
                  <a href="t.me/GK88_THUONGNGHINTY" className="text-orange-100 hover:text-white flex items-center">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full md:w-2/12">
              ...
              <div className="flex gap-2">
                <a href="https://gk88.ai/" className="bg-orange-400 hover:bg-white text-white hover:text-orange-500 w-9 h-9 rounded-full flex items-center justify-center transition-colors">
                ...
                <a href="https://t.me/GK88HOTRO24H_BOT" className="bg-orange-400 hover:bg-white text-white hover:text-orange-500 w-9 h-9 rounded-full flex items-center justify-center transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="border-t border-orange-400 pt-4 flex flex-col md:flex-row justify-between items-center">
            <div className="text-sm text-orange-100 mb-2 md:mb-0">
              © 2025 <span className="font-semibold"><a href="https://gk88.ai/" className="hover:text-white transition-colors">GK88</a></span>. Trung Tâm Khuyến Mãi GK88. Tất cả các quyền được bảo lưu bởi NEWPEI.
            </div>
            <div className="text-xs text-orange-200">
              <a href="https://gk88.ai/" className="hover:text-white mx-2">Điều khoản sử dụng</a>
              <span className="mx-2">|</span>
              <a href="https://gk88.ai/" className="hover:text-white mx-2">Chính sách bảo mật</a>
            </div>
          </div>
        </div>
      </footer>
